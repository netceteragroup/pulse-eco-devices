const char RESET_REQUEST_page[] PROGMEM = R"=====(
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 ...
 <p>INFO</p>
  <div class='line'></div>
  <div>Reseting the device will remove all stored settings about the device key and network. <br/>You'll need to manually connect back to the device and configure it up from the beggining.<br/>Are you sure you want to continue?</div>
  <form method='post' action='/reset'>
   <div><input id='submit' type='submit' value='Device Reset' /></div>
 </form>
</body>
</html>
)=====";